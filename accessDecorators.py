...
def ensureRegistered(func: WrappableFunction) -> WrappableFunction:
    ...
    def wrapper_is_registered(self: Any, args: list[str], author: discord.Member, reply: replyFunction):
...
def ensureAdmin(func: WrappableFunction) -> WrappableFunction:
    ...
    """
    @functools.wraps(func)
    def wrapper_is_admin(self: Any, args: list[str], author: discord.Member, reply: replyFunction):
